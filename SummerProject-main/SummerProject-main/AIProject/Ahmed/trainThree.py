...
def file2matrix():
    ...
    # Print out the number of each level
    level_counts = df['Level'].value_counts()
    print("Number of Low risk cases: ", level_counts.get(0, 0))
    print("Number of Medium risk cases: ", level_counts.get(1, 0))
    print("Number of High risk cases: ", level_counts.get(2, 0))
